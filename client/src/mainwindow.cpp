...
{
    ui->refresh->setGeometry(350,240,200,50);
    ui->serverinfo->setGeometry(50,240,300,50);


    ui->label->setGeometry(50,1100,300,50);
    ui->inputfilename->setGeometry(200,1100,300,50);
    ui->download->setGeometry(500,1100,200,50);



    ui->clientinfo->setGeometry(1200,240,300,50);

    ui->label_2->setGeometry(1200,1100,300,50);
    ui->inputfilename_2->setGeometry(1350,1100,300,50);
    ui->upload->setGeometry(1650,1100,200,50);

    ui->scrollArea->setGeometry(50,300,1000,800);
        ui->scrollArea_2->setGeometry(1200,300,1000,800);
        ui->treeView->setGeometry(0,0,1000,800);
        pProgressBar->setGeometry(700,30,1000,100);
}
